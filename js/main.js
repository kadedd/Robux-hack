	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Generating Packets for item1");	
					$processing_message.html("Generating Packets for item1");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 14000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Robux");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> <span class='console-message-success'>Robux Generated Successfully</span>");
				...
				setTimeout(function() { 
					...
					$console_message.html("Generating Packets for item2");	
					$processing_message.html("Generating Packets for item2");	
					progressBarConsole(58, $('#progressBarConsole'));			
				}, 23000 );
				setTimeout(function() { 
					$('.starting-loading-wrapper').fadeOut(500, function() {
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> TIX");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> <span class='console-message-success'>TIX Generated Successfully</span>");
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit generator out there');
                        setTimeout(function() {
